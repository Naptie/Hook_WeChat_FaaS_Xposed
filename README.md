...
| POST /invoke | {"appId": "wxafec6f8422cb357b","jsapi_name": "login","data": "{\\"requestInQueue\\":false}"} |                                                  JSON                                                  |     调用云函数，返回执行结果      |
|  GET /logs   |                                              无                                               | ["[WX-FaaS-HOOK] Find app: com.tencent.mm","[WX-FaaS-HOOK] start embeddedServer at 0.0.0.0:59999",...] |      查询近1500条日志       |
